...
computacional, solo se puede realizar una aproximaci\'on a la realidad. Existen algoritmos muy complejos y se ataca actualmente el problema con \tetxit{Machine Learning}, sin lograr resultados del todo contundentes, por eso nos basamos en los cl\'asicos algoritmos matem\'aticos para intentar una soluici\'on mejor modelada del problema. 
